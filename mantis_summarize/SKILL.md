---
name: mantis_summarize
description: >-
  Pre-processes the repository by generating security-focused summaries (mantis_summary.md) for each directory to make planning and research more efficient.
